...
(function() {
   ...
   var photo1 = {id: 1, date_time: "2012-08-30 10:44:23", file_name: "ouster.jpg", user: jo, visibleTo: [im, pt, jo], favoritedBy: [im,pt]};
   var photo2 = {id: 2, date_time: "2009-09-13 20:00:00", file_name: "malcolm2.jpg", user: im, visibleTo: [pt,er,im], favoritedBy: [pt,er]};
   var photo3 = {id: 3, date_time: "2009-09-13 20:05:03", file_name: "malcolm1.jpg", user: im, visibleTo: [im], favoritedBy: []};
   var photo4 = {id: 4, date_time: "2013-11-18 18:02:00", file_name: "ripley1.jpg", user: er, visibleTo: [pt,rk,al, er], favoritedBy: [pt,rk,al]};
   var photo5 = {id: 5, date_time: "2013-09-20 17:30:00", file_name: "ripley2.jpg", user: er, visibleTo: [rk,al, er], favoritedBy: [rk,al]};
   var photo6 = {id: 6, date_time: "2009-07-10 16:02:49", file_name: "kenobi1.jpg", user: rk, visibleTo: [al,rk], favoritedBy: [al]};
   var photo7 = {id: 7, date_time: "2010-03-18 23:48:00", file_name: "kenobi2.jpg", user: rk, visibleTo: [rk,al,jo,im], favoritedBy: [rk,al,jo]};
   var photo8 = {id: 8, date_time: "2010-08-30 14:26:00", file_name: "kenobi3.jpg", user: rk, visibleTo: [al, rk, jo], favoritedBy: [al,jo]};
   var photo9 = {id: 9, date_time: "2013-12-03 09:02:00", file_name: "took1.jpg", user: pt, visibleTo: [im, pt], favoritedBy: [im]};
   var photo10 = {id: 10, date_time: "2013-12-03 09:03:00", file_name: "took2.jpg", user: pt, visibleTo: [er, pt, al], favoritedBy: [er]};
   var photo11 = {id: 11, date_time: "2013-09-04 09:16:32", file_name: "ludgate1.jpg", user: al, visibleTo: [rk,al], favoritedBy: [rk]};
   var photo12 = {id: 12, date_time: "2008-10-16 17:12:28", file_name: "kenobi4.jpg", user: rk, visibleTo: [rk,pt,al], favoritedBy: []};
   ...
   var actualComments = [comment1, comment2, comment3, comment4, comment5, comment6, comment7,
   comment8, comment9, comment10, comment11, comment12, comment13];
   ...
   var commentsListModel = function(){
     return actualComments;
   };

   var commentsOfUserModel = function(userId) {
      return actualComments.filter(function (comment) {
